      ...
      <div className="overflow-x-auto">
        ...
        <div className='flex justify-between'>
          ...
          <button className="btn btn-sm mx-2 btn-success text-white" onClick={handleExportExcel}>
            ...
            <div className="tooltip tooltip-left" data-tip="Refresh Table">
                <svg onClick={() => {
                ...
                }}  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30" className='cursor-pointer '>
